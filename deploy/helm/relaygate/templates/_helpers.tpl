...
{{- if or (has .name $managed) (has .name (list "RELAYGATE_INTERNAL_TRANSPORT" "RELAYGATE_SDK_TRANSPORT" "RELAYGATE_INSECURE_TEST_TRANSPORT" "RELAYGATE_RT_TRUSTED_LOCAL")) }}
...
{{- end }}
{{- end }}
{{- $reservedAnnotations := list "checksum/shard-directory" "prometheus.io/scrape" "prometheus.io/path" "prometheus.io/port" -}}

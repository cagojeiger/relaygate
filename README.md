...
계약: [SPEC 001](docs/spec/001-system-model.md), [SPEC 003](docs/spec/003-failure-and-recovery-model.md), [SPEC 004](docs/spec/004-state-transition-model.md). 검증: [TEST 001](docs/test/001-core-correctness-test-plan.md), [TEST 002](docs/test/002-failure-evidence-matrix.md). 결정 기록: [ADR 색인](docs/adr/README.md), 특히 [ADR 002](docs/adr/002-runtime-and-release-boundary.md), [ADR 003](docs/adr/003-current-state-cluster-and-recovery.md), [ADR 004](docs/adr/004-control-state-authority-split.md).

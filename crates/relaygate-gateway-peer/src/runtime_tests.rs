...
impl RuntimePair {
    ...
    fn request_b_to_a(&self, connection_id: u64) -> TestResult<PeerOpenRequest> {
        Ok(PeerOpenRequest::new(
            ...
            crate::test_support::destination("echo.a"),
            SessionId::new(),
            BindingId::new(),
        ))
    }
...
fn test_config(local_name: &str) -> Result<GatewayPeerConfig, crate::PeerConfigError> {
...
) -> Result<GatewayPeerConfig, crate::PeerConfigError> {

...
impl PeerTarget {
    #[must_use]
    pub const fn new(gateway_id: GatewayId, gateway_locator: GatewayLocator) -> Self {
        Self {
            gateway_id,
            gateway_locator,
        }
    ...
    #[must_use]
    pub const fn gateway_locator(&self) -> &GatewayLocator {
...
impl PeerOpenRequest {
    ...
    #[must_use]
    pub const fn target(&self) -> &PeerTarget {
        &self.target
    }

    #[must_use]
    pub const fn open_identity(&self) -> OpenIdentity {
        self.open_identity
    }

    #[must_use]
    pub fn destination(&self) -> &relaygate_protocol::Destination {
        &self.destination
    }

    #[must_use]
    pub const fn relay_session_id(&self) -> SessionId {
...
impl PeerStreamKey {
    ...
    #[must_use]
    pub const fn peer_gateway_id(self) -> GatewayId {
        self.peer_gateway_id
    }

    #[must_use]
    pub const fn peer_transport_id(self) -> PeerTransportId {
...
impl PeerFailure {
    #[must_use]
    pub fn new(code: ErrorCode, observation: PeerObservation, message: impl Into<String>) -> Self {
        Self {
            code,
            observation,
    ...
    #[must_use]
    pub fn not_observed(code: ErrorCode, message: impl Into<String>) -> Self {
        Self::new(code, PeerObservation::NotObserved, message)
    }

    #[must_use]
    pub fn maybe_observed(code: ErrorCode, message: impl Into<String>) -> Self {
    ...
    #[must_use]
    pub const fn metric_code(&self) -> &'static str {
        match self.code {
...
pub struct LostPeerStream {
    pub key: PeerStreamKey,
    pub open_identity: OpenIdentity,
    pub progress: PeerOpenProgress,
}

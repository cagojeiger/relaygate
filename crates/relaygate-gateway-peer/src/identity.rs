...
pub struct PeerHandshake {
    ...
    pub dialer_gateway_id: GatewayId,
    pub peer_transport_id: PeerTransportId,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub struct PeerTransportId(Uuid);
...
impl Default for PeerTransportId {
    fn default() -> Self {
        Self::new()
    }
}
...
impl OpenIdentity {
    ...
    #[must_use]
    pub const fn entry_gateway(self) -> GatewayId {
        self.entry_gateway
    }
...
impl PeerOpenProgress {
    #[must_use]
    pub const fn failure_observation(self) -> PeerObservation {
        match self {
            #[cfg(test)]

...
func (x *ListenerBindingRef) GetGatewayId() string {
	if x != nil {
		return x.GatewayId
	}
	return ""
...
func (x *AuthContext) GetAuthRevision() string {
	if x != nil {
...
func (x *AdmitOpenRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *AdmitOpenRequest) GetAuth() *AuthContext {
	if x != nil {
		return x.Auth
	}
	return nil
...
func (x *AdmitOpenRequest) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *AdmitOpenRequest) GetTargetId() string {
	if x != nil {
		return x.TargetId
	}
	return ""
...
func (x *OpenContext) GetAuthorityId() string {
	if x != nil {
		return x.AuthorityId
	}
	return ""
...
func (x *OpenContext) GetAttemptId() string {
	if x != nil {
		return x.AttemptId
	}
	return ""
...
func (x *OpenContext) GetAuth() *AuthContext {
	if x != nil {
		return x.Auth
	}
	return nil
...
func (x *AdmitOpenResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_proto_relaygate_control_v1_control_proto_rawDesc = "" +
	...
	"\ttarget_id\x18\x03 \x01(\tR\btargetId\"\x93\x01\n" +
	...
	"\rauth_revision\x18\x04 \x01(\tR\fauthRevision\"\xbe\x01\n" +
	"\x10AdmitOpenRequest\x12:\n" +
	...
	"\tAdmitOpen\x12&.relaygate.control.v1.AdmitOpenRequest\x1a'.relaygate.control.v1.AdmitOpenResponseBCZAgithub.com/cagojeiger/relaygate/internal/gen/control/v1;controlv1b\x06proto3"
